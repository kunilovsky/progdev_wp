...
function progdev_setup() {
	/*
		...
		* If you're building a theme based on ProgDev, use a find and replace
		* to change 'progdev' to the name of your theme in all the template files.
		*/
...
function progdev_scripts() {
	wp_enqueue_style( 'progdev-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'progdev-style', 'rtl', 'replace' );

	wp_enqueue_script( 'progdev-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
